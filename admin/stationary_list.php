...
<html lang="en">
  <head>
    ...
    <title>BMS | Stationary Lists</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>Stationary Lists</h3>
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-files-o"></i>Stationary Lists</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
...
<?php 
			...
			$sql="select t1.id,t1.particulars,t1.quantity,t1.mrp,t1.discount,t1.cost,t3.class,t4.name as school from tbl_stationary t1,tbl_class t3,tbl_school t4 where t1.class_id=t3.id and t1.school_id=t4.id order by t1.id asc limit $offset,$count";
			
			$sql1="select count(id) as count from tbl_stationary";
				...
				$pages= ceil($rownum/$count);
					 ...
					 while($result=$rs->fetch_array()){
						 ...
						 <td align="center"><?php echo $result['particulars'];?></td>
						 ...
						 <td align="center">
                             <a href="edit_stationary.php?id=<?php echo $result['id']; ?>" class="fa fa-edit"></a>&nbsp;&nbsp;
                             <a href="delete_stationary.php?id=<?php echo $result['id'];?>" class="fa fa-trash-o" onClick="return confirmDelete();"></a>
                         </td>    
						 </tr>
						 <?php
					   }
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="stationary_list.php?page=<?php echo $page-1;?>">Prev</a></li>
          	</ul>
    <?php
			}
			for($i=1;$i<=$pages;$i++){
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="stationary_list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
          	</ul>
    <?php		
				}
	...
	?>
    		<ul class="pagination pagination-sm">
    			<li><a href="stationary_list.php?&page=<?php echo $page+1;?>">Next</a></li>
          	</ul>
    <?php
			}
	?>
...
function searchResult()
{
	...
	var xhttp = new XMLHttpRequest();
		  ...
		  xhttp.open("GET", "stationary_search.php?school="+school+"&cls="+cls, true);
		  xhttp.send();
}

function confirmDelete(){
			if(confirm("Are you sure you want to delete this Stationary?")){
				return true;
			}else{return false;}
		}
</script>   
