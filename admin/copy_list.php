...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>Copy Lists</h3>
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>Copy</li>
						<li><i class="fa fa-files-o"></i>Copy Lists</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
...
<?php 
			...
			$sql="select t1.id as copy_id,t1.name as copy_name,t1.pages,t1.quality,t1.quantity,t1.mrp,t1.discount,t1.cost,t3.class,t4.name as school from tbl_copy t1,tbl_class t3,tbl_school t4 where t1.class_id=t3.id and t1.school_id=t4.id order by t1.id asc limit $offset,$count";
				...
				$pages= ceil($rownum/$count);
					 ...
					 while($result=$rs->fetch_array()){
						 ...
						 <td align="center">
                             ...
                             <a href="delete_copy.php?id=<?php echo $result['copy_id'];?>" class="fa fa-trash-o" onClick="return confirmDelete();"></a>
                         </td>    
						 </tr>
						 <?php
					   }
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="copy_list.php?page=<?php echo $page-1;?>">Prev</a></li>
          	</ul>
    <?php
			}
			for($i=1;$i<=$pages;$i++){
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="copy_list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
          	</ul>
    <?php		
				}
	...
	?>
    		<ul class="pagination pagination-sm">
    			<li><a href="copy_list.php?&page=<?php echo $page+1;?>">Next</a></li>
          	</ul>
    <?php
			}
	?>
...
function searchResult()
{
	...
	var xhttp = new XMLHttpRequest();
		  ...
		  xhttp.open("GET", "copy_search.php?school="+school+"&cls="+cls, true);
		  xhttp.send();
}
