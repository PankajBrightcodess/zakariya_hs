...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>Pincode Lists</h3>
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-files-o"></i>pincode Lists</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
...
<?php 
			...
			$sql="select * from tbl_pincode order by id desc limit $offset,$count";
			
			$sql1="select count(id) as count from tbl_pincode";
				...
				$pages= ceil($rownum/$count);
					 ...
					 while($result=$rs->fetch_array()){
						 ...
						 <td align="center">
                             <a href="delete_pincode.php?id=<?php echo $result['id'];?>" class="fa fa-trash-o"  onClick="return confirmDelete();"></a>
                         </td>    
						 </tr>
						 <?php
					   }
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="pincode_list.php?page=<?php echo $page-1;?>">Prev</a></li>
          	</ul>
    <?php
			}
			for($i=1;$i<=$pages;$i++){
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="pincode_list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
          	</ul>
    <?php		
				}
	...
	?>
    		<ul class="pagination pagination-sm">
    			<li><a href="pincode_list.php?&page=<?php echo $page+1;?>">Next</a></li>
          	</ul>
    <?php
			}
	?>
...
function searchResult(data)
{
	...
	var xhttp = new XMLHttpRequest();
		  ...
		  xhttp.open("GET", "pincode_search.php?query="+query, true);
		  xhttp.send();
}
