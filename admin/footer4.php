...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>Follow Us</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Footer4</li>
						<li><i class="fa fa-files-o"></i>Follow Us</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
...
<?php 
			...
			$sql="select * from tbl_footer where footer='4' order by id asc limit $offset,$count";
			$sql1="select count(id) as count from tbl_footer where footer='4'";
