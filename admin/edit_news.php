...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i> Edit News</h3>
					<ol class="breadcrumb">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="" method="post" action="update_news_data.php">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <input class=" form-control" id="title" name="title" type="text" value="<?php echo $data['title'] ?>" placeholder="Title" />
                                          </div>
                                      </div>
                                       <div class="form-group ">
                                          <label for="Link" class="control-label col-lg-2">Link <span class="required">*</span></label>
                                          <div class="col-lg-3">
                                              <input class=" form-control" id="link" name="link" type="text" value="<?php echo $data['link'] ?>" placeholder="Link" required />
                                          </div>
                                      </div>
                                       <div class="form-group ">
                                         <label for="description" class="control-label col-lg-2">Description</label>
                                          <div class="col-lg-3">
                                           <textarea name="description" id="description" class="form-control" style="resize:vertical;" placeholder="Description"><?php echo $data['description'] ?></textarea>  
                                          </div>
                                      </div>
                                       ...
                                       <div class="form-group ">
                                        <label for="Active" class="control-label col-lg-2 col-sm-3">Active</label>
                                          <div class="col-lg-1 col-sm-5">
                                              <input  type="radio" style="width: 20px" class="checkbox form-control" id="published" name="published" value="1" <?php if($data['published']=='1'){ ?> checked <?php } ?> />
                                          </div>
                                          <label for="Inactive" class="control-label col-lg-2 col-sm-3">Inactive</label>
                                          <div class="col-lg-1 col-sm-5">
                                             <input  type="radio" style="width: 20px" class="checkbox form-control" id="published" name="published" value="0" <?php if($data['published']=='0'){ ?> checked <?php } ?>/>
                                          </div>
                                      </div>
                                    
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" type="submit" name="submit">Update News</button>
