...
<html lang="en">
  <head>
    ...
    <title>BMS | Shipping & Policies</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>Shipping & Policies</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Footer1</li>
						<li><i class="fa fa-files-o"></i>Shipping & Policies</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
...
<?php 
			...
			$sql="select * from tbl_footer where footer='1' order by id asc limit $offset,$count";
			$sql1="select count(id) as count from tbl_footer where footer='1'";
				...
				$pages= ceil($rownum/$count);
					 ...
					 while($result=$rs->fetch_array()){
                        ...
                        <td align="center"><?php echo "Footer".$result['footer'];?></td>
						 ...
						 <td align="center">
						     <a href="edit_footer.php?id=<?php echo $result['id']; ?>&footer=<?php echo $result['footer'] ?>" class="fa fa-edit"></a>&nbsp;&nbsp;
                         </td>    
						 </tr>
						 <?php
					   }
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="footer_list.php?page=<?php echo $page-1;?>">Prev</a></li>
          	</ul>
    <?php
			}
			for($i=1;$i<=$pages;$i++){
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="footer_list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
          	</ul>
    <?php		
				}
	...
	?>
    		<ul class="pagination pagination-sm">
    			<li><a href="footer_list.php?&page=<?php echo $page+1;?>">Next</a></li>
          	</ul>
    <?php
			}
	?>
