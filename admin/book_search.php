...
<?php 
			...
			$sql="select t1.id as book_id,t1.name as book,t1.mrp,t1.discount,t1.cost,t2.name as subject,t3.class,t4.name as school from tbl_books t1,tbl_subject t2,tbl_class t3,tbl_school t4 where t1.subject_id=t2.id and t1.class_id=t3.id and t1.school_id=t4.id ";
				...
				$pages= ceil($rownum/$count);
					 ...
					 while($result=$rs->fetch_array()){
						 ...
						 <td align="center">
                             ...
                             <a href="delete_book.php?id=<?php echo $result['book_id'];?>" class="fa fa-trash-o"></a>
                         </td>    
						 </tr>
						 <?php
					   }
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="book_list.php?page=<?php echo $page-1;?>&school=<?php echo $school;?>&cls=<?php echo $cls;?>">Prev</a></li>
          	</ul>
    <?php
			}
			for($i=1;$i<=$pages;$i++){
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="book_list.php?page=<?php echo $i; ?>&school=<?php echo $school;?>&cls=<?php echo $cls;?>"><?php echo $i; ?></a>
                </li>
          	</ul>
    <?php		
				}
	...
	?>
    		<ul class="pagination pagination-sm">
    			<li><a href="book_list.php?&page=<?php echo $page+1;?>&school=<?php echo $school;?>&cls=<?php echo $cls;?>">Next</a></li>
          	</ul>
    <?php
			}
	?>
