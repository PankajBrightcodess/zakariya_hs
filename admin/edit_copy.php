...
include "class/copy.php";
$id=$_GET['id'];
$obj=new Copies();
$cpy=$obj->get_copy_by_id($id);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i> Edit Copy</h3>
      <div class="col-md-12">
     <div class="row" style="height: 20px;" id="remove_msg">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-files-o"></i>Edit Copy</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="" method="post" action="update_copies_data.php">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <select name="school_id" id="school_id" class="form-control select2" disabled>
												 ...
												 ?>
                                                 <option value="<?php echo $school['id'] ?>"<?php if($cpy['school']==$school['name']){ ?> selected <?php } ?>><?php echo $school['name'] ?></option>
                                                 <?php endforeach; ?>
                                              </select>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                                <select name="class_id" id="class_id" class="form-control" disabled>
												 ...
												 foreach($val as $cls):
												 ?>
                                                 <option value="<?php echo $cls['id'] ?>" <?php if($cpy['class']==$cls['class']){ ?> selected <?php } ?>><?php echo $cls['class'] ?></option>
                                                 <?php endforeach; ?>
                                              </select>
                                          </div>
                                      </div>
                                     ...
                                     <div id="product">
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" type="submit" name="submit">Update Copy</button>
