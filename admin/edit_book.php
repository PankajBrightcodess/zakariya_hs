...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i> Edit Books</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Books</li>
						<li><i class="fa fa-files-o"></i>Edit Books</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="" method="post" action="update_books_data.php">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <select name="school_id" id="school_id" class="form-control select2" disabled>
												 ...
												 ?>
                                                 <option value="<?php echo $school['id'] ?>" <?php if($bk['school']==$school['name']){ ?> selected <?php } ?>><?php echo $school['name'] ?></option>
                                                 <?php endforeach; ?>
                                              </select>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                           <select name="class_id" id="class_id" class="form-control" disabled>
												 ...
												 foreach($val as $cls):
												 ?>
                                                 <option value="<?php echo $cls['id'] ?>" <?php if($bk['class']==$cls['class']){ ?> selected <?php } ?>><?php echo $cls['class'] ?></option>
                                                 <?php endforeach; ?>
                                              </select>
                                          </div>
                                      </div>
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <select name="subject_id" id="subject_id" class="form-control" disabled>
												 ...
												 foreach($val as $sub):
												 ?>
                                                 <option value="<?php echo $sub['id'] ?>" <?php if($bk['subject']==$sub['name']){ ?> selected <?php } ?>><?php echo $sub['name'] ?></option>
                                                 <?php endforeach; ?>
                                              </select>
                                          </div>
                                      </div>
                                     <div id="product">
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" type="submit" name="submit">Update Books</button>
