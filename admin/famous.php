...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>Famous List</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Famous</li>
						<li><i class="fa fa-files-o"></i>Famous List</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
       ...
       <div class="col-lg-12">
        ...
        <form action="add_famous.php" method="post" onSubmit=" checkThis();">
          <table class="table table-hover table-stripped" >
			   <thead>
				 ...
				 <th style="text-align:center">Set Famous</th>
			   </thead>
<?php 
			...
			$sql1="select count(id) as count from tbl_school";
				...
				$pages= ceil($rownum/$count);
					 ...
					 while($result=$rs->fetch_array()){$i++;
                         ...
                         <?php
						    $fam = "SELECT  `famous` FROM `tbl_images` WHERE school_id='$result[id]'";
							$q=$conn->query($fam);
							$data=$q->fetch_array();
							//echo $data['famous'];
						  ?>
                              <input type="hidden" name="school_id[]" value="<?php echo $result['id'] ?>">
                              <input type="hidden" name="famous[]" id="famous<?php echo $i; ?>" >
                              <input type="checkbox" name="checkfamous[]" id="checkfamous<?php echo $i; ?>" <?php if($data['famous']==1){ ?> checked <?php } ?> >
                         </td>    
						 </tr>
						 <?php
					   }
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="famous.php?page=<?php echo $page-1;?>">Prev</a></li>
          	</ul>
    <?php
			}
			for($i=1;$i<=$pages;$i++){
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="famous.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
          	</ul>
    <?php		
				}
	...
	?>
    		<ul class="pagination pagination-sm">
    			<li><a href="famous.php?&page=<?php echo $page+1;?>">Next</a></li>
          	</ul>
    <?php
			}
	?>
    ...
    <div class="form-group">
          <div class="col-lg-offset-2 col-lg-10">
              ...
              <button class="btn btn-primary" type="submit" name="submit">Add Famous</button>
          </div>
      </div>
</form>			  
</div>
