...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>School Lists</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Schools</li>
						<li><i class="fa fa-files-o"></i>School Lists</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
...
<?php 
			...
			$sql1="select count(id) as count from tbl_school";
				...
				$pages= ceil($rownum/$count);
					 ...
					 while($result=$rs->fetch_array()){
						 ...
						 <td align="center">
						     <a href="edit_school.php?id=<?php echo $result['id']; ?>" class="fa fa-edit"></a>&nbsp;&nbsp;
                             <a href="delete_school.php?id=<?php echo $result['id'];?>" class="fa fa-trash-o" onClick="return confirmDelete();"></a>
                         </td>    
						 </tr>
						 <?php
					   }
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="school_list.php?page=<?php echo $page-1;?>">Prev</a></li>
          	</ul>
    <?php
			}
			for($i=1;$i<=$pages;$i++){
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="school_list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
          	</ul>
    <?php		
				}
	...
	?>
    		<ul class="pagination pagination-sm">
    			<li><a href="school_list.php?&page=<?php echo $page+1;?>">Next</a></li>
          	</ul>
    <?php
			}
	?>
